...
def cambiar_clave():
  ...
  antigua = input("Ingrese clave actual: ")
  nueva = input("Ingrese clave nueva: ")

  resultado = session.cambiarClave(usuario, antigua, nueva)
  if resultado == True:
    print("Cambio de contraseña completado.")
  else:
